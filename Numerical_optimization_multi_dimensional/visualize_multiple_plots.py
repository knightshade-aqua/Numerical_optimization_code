...
def visualize_contour(x_trajectory_cg, trust_radius_cg, trajectory_dl, trust_radius_dl, trajectory_cp, objective):
    ...
    ax.scatter(x_trajectory_cg[:,0],x_trajectory_cg[:,1], marker='o', label='Conjugate gradient Steihaug trajectory')
    ax.scatter(trajectory_dl[:,0],trajectory_dl[:,1], marker='x',  label='Dog leg trajectory')
    ax.scatter(trajectory_cp[:,0],trajectory_cp[:,1], marker='*', label='Cauchy point trajectory')
...
def plot_radius(x_trajectory_cg, trust_radius_cg, trajectory_dl, trust_radius_dl, trajectory_cp, trust_radius_cp, objective):
    ...
    ax = fig.add_subplot()
    cp = ax.contour(x,y, f, np.arange(2,10)**4)
    ax.plot(x_trajectory_cg[:,0],x_trajectory_cg[:,1], label='Conjugate gradient Steihaug trajectory')
    ...
    ax.set_ylabel('Y',fontsize=16,fontweight='bold')
    ax.legend()
    plt.savefig("Images/2d_contour_plot_steihaug.png", dpi=250)
    plt.show()
    ...
    ax = fig.add_subplot()
    cp = ax.contour(x,y, f, np.arange(2,10)**4)
    ax.plot(trajectory_dl[:,0],trajectory_dl[:,1], label='Dog leg trajectory')
    ...
    ax.set_ylabel('Y',fontsize=16,fontweight='bold')
    ax.legend()
    plt.savefig("Images/2d_contour_plot_dog_leg.png", dpi=250)
    plt.show()
    ...
    ax = fig.add_subplot()
    cp = ax.contour(x,y, f, np.arange(2,10)**4)
    ax.plot(trajectory_cp[:,0],trajectory_cp[:,1], label='Cauchy point trajectory')
    ...
    ax.set_ylabel('Y',fontsize=16,fontweight='bold')
    ax.legend()
    plt.savefig("Images/2d_contour_plot_cauchy.png", dpi=250)
    plt.show()
